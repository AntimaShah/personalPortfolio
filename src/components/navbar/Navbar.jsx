        ...
        {isDesktopOrLaptop ? (
          ...
          >
            ...
            <figure className={styles.profile}>
              <img
                src="https://i.postimg.cc/3NC9Bw8J/woman.png"
                alt="profile"
              />
            </figure>
            <h2>{t("name")}</h2>
            ...
            <ul className={styles.socials}>
              ...
              <li>
                <a
                  href="https://www.instagram.com/shah_antima.90/"
                  target="_blank"
                  rel="noreferrer"
                >
                  <BsInstagram />
              ...
              <li>
                <a
                  href="https://www.linkedin.com/in/antima-shah/"
                  target="_blank"
                  rel="noreferrer"
                >
                  <ImLinkedin2 />
              ...
              <li>
                <a
                  href="https://github.com/AntimaShah"
                  target="_blank"
                  rel="noreferrer"
                >
                  <BsGithub />
          ...
          >
            ...
            <ul className={styles.socials}>
              ...
              <li>
                <a
                  href="https://www.instagram.com/shah_antima.90/?next=%2F"
                  target="_blank"
                  rel="noreferrer"
                >
                  <BsInstagram />
